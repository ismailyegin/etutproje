# Generated by Django 2.2.4 on 2020-04-26 14:11
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('eventPlace', models.CharField(blank=True, max_length=1000, null=True)),
                ('compType', models.IntegerField(blank=True, choices=[('Üniversiteler Arası', 'Üniversiteler Arası'), ('Okullar Arası', 'Okullar Arası'), ('Ferdi', 'Ferdi')], null=True)),
                ('compGeneralType', models.IntegerField(blank=True, choices=[('Türkiye', 'Türkiye'), ('Dünya', 'Dünya'), ('Olimpiyat', 'Olimpiyat'), ('Avrupa', 'Avrupa')], null=True)),
                ('juryCount', models.IntegerField(blank=True, null=True)),
